...
export default function CommentSection({ postId }) {
    ...
    return (
        <div className="w-full max-w-2xl p-3 mx-auto relative">
            {currentUser ? (
            ...
            {showModal && (
                <div className="absolute p-4 bg-white border top-4 left-4 ">
                    <h3>정말로 삭제하시겠습니까?</h3>
                    <div className="flex text-sm mt-2 justify-center">
                        <button className="block px-4 py-2 mr-2 text-white bg-red-500" onClick={() => handleDelete(commentToDelete)}>네</button>
                        <button className="block px-4 py-2 text-white bg-blue-500" onClick={() => setShowModal(false)}>아니요</button>
                    </div>
